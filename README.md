...
### Bước 1: Service Account chính xác
Dựa trên cấu hình IAM của bạn, Service Account duy nhất đang được sử dụng là:
`firebase-adminsdk-fbsvc@project-5306ce34-5626-488a-913.iam.gserviceaccount.com`

### Bước 2: Gán quyền Billing
1. Truy cập trang **Billing** trong Google Cloud Console: [https://console.cloud.google.com/billing](https://console.cloud.google.com/billing)
2. Chọn Billing Account của bạn (ID: `017D0B-3695DA-8D7FB7`).
...
- **Không bao giờ hết hạn**: Không yêu cầu nhập lại mã hay đăng nhập lại sau mỗi phiên làm việc.
- **Chính xác 100%**: Dữ liệu lấy trực tiếp từ hệ thống kế toán của Google cho dự án `project-5306ce34-5626-488a-913`.
- **Bảo mật**: Chỉ có quyền xem thông tin thanh toán, không thể can thiệp vào tài nguyên hay dữ liệu cá nhân khác của bạn.
